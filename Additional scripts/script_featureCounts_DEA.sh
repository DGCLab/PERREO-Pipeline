# We ran this simplified version of perreo_srpe.sh script in order to only study the elapsed time and CPU consumption during featureCounts and DEA analysis drawing from the premise that we had previously run 
# the trimming and alignment process to analyze the data. 
