...
ggplot(hybrid_transcripts, aes(x = condition, y = hybrid_frac, fill = condition)) +
...
ggsave(paste0(CWD,"/hybrid_transcripts.pdf"), plot = p_corrected, width = 8, height = 6, dpi = 300)
